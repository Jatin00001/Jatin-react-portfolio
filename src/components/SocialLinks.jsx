    ...
    <div className='hidden lg:flex flex-col top-[35%] left-0 fixed'>
      <ul>
        {links.map ( ({id,child,href,download,style}) =>(
             <li key={id} className={"flex justify-between items-center w-40 h-14 px-4 bg-gray-500 text-white ml-[-100px] hover:rounded-md duration-300 hover:ml-[-10px] " + style}>
